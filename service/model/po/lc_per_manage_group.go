...
type LcPerManageGroup struct {
	...
	AppPackageIds string    `db:"app_package_ids,omitempty" json:"appPackageIds"` // 应用包权限
	AppIds        string    `db:"app_ids" json:"appIds"`                          // 应用权限
	//UsageIds      string    `db:"usage_ids,omitempty" json:"usageIds"`            // 功能权限 【废弃】
	OptAuth      string     `db:"opt_auth,omitempty" json:"optAuth"`              // 功能权限
